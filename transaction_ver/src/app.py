        ...
        try:
            ...
            if response.is_valid:
                return transaction_ver.VerifyTransactionResponse(is_valid=True,
                                                                 vector_clock=transaction_ver.VectorClock(clock=response.vector_clock.clock))
...
class TransactionVerificationService(transaction_ver_grpc.TransactionVerificationServiceServicer):
    def VerifyTransaction(self, request, context):
        ...
        try:
            ...
            print("Transaction verification service fraud detection service response received.")
            return transaction_ver.VerifyTransactionResponse(is_valid=fraud_response.is_valid,
                                                                      error_message=fraud_response.message,
                                                                      vector_clock=vector_clock.clock)
        except Exception as e:
